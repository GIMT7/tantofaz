    ...
    >
      <div className="container">
          ...
          <div className="col-lg-6">
            <div className="sectionTitle ">
              <h2 className="sectionTitle__title " data-aos="fade-left">
                Aprenda com os melhores instrutores da Nexus Educação
              </h2>

              <p className="sectionTitle__text " data-aos="fade-left">
                Descubra conteúdos incríveis e transforme seu aprendizado.
              </p>
            </div>
          </div>
        ...
        <div className="row justify-center text-center pt-60 lg:pt-40">
          <div className="col-auto">
            <p className="lh-1">
              Quer ajudar pessoas a aprender, crescer e alcançar mais na vida?
              <Link className="text-purple-1 underline" to="/instructor-become">
                Torne-se um instrutor na Nexus Educação
              </Link>
            </p>
          </div>
        </div>
