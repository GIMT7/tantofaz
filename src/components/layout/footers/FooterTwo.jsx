      ...
      <div className="container">
        <div className="row y-gap-30 justify-between pt-60">
          ...
          <div className="col-xl-4 col-lg-5 col-md-6">
            ...
            <img
                      src="/assets/img/general/download (1).svg"
                      alt="logo"
            ...
            <div className="">
              ...
              <div className="d-flex mt-15">
                ...
                <div className="d-flex items-center rounded-8 px-25 py-10 footer-bg-color ml-10">
                  ...
                  <div className="text-white ml-20">
                    <div className="text-13 lh-12">Disponível no</div>
          ...
          <div className="row justify-between items-center y-gap-20">
            <div className="col-auto">
              <div className="d-flex items-center h-100 text-white">
                © {new Date().getFullYear()} Nexus Educação. Todos os direitos reservados.
              </div>
            </div>
