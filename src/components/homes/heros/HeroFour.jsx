          ...
          >
            <div className="masthead__content pl-32 lg:pl-0">
              <h1 className="masthead__title">
                ...
                <br /> <span className="text-purple-1">Preferidos</span> e Melhore
                Suas Habilidades
              </h1>

              <p className="masthead__text text-17 text-dark-1 mt-25">
                Desenvolva habilidades com cursos, certificados e diplomas online da
                <br className="lg:d-none" /> Nexus Educação, conectando você a especialistas e instituições renomadas.
              </p>
