        ...
        <div className="row y-gap-30 justify-between items-center">
          <div className="col-xl-5 col-lg-6 col-md-9 lg:order-2">
            <h3 className="text-45 md:text-30 lh-12">
              <span className="text-purple-1">Aprenda</span> novas habilidades quando
              <br className="lg:d-none" /> e onde quiser.
            </h3>
            <p className="mt-20">
              Use a lista abaixo para destacar os principais diferenciais
              <br className="lg:d-none" /> dos cursos da Nexus Educação.
            </p>
