              ...
              <div className="row y-gap-30 relative">
                <div className="col-xl-7 col-lg-8">
                  ...
                  <p className="col-xl-9 mt-20">
                    Use o XD para conseguir um emprego em Design de Interface do Usuário, Experiência do Usuário e Web Design.
                  </p>
                  ...
                  <div className="d-flex x-gap-30 y-gap-10 items-center flex-wrap pt-20">
                    ...
                    <div className="d-flex items-center text-light-1">
                      ...
                      <div className="text-14 ml-8">Última atualização em 11/2021</div>
                    </div>
                  </div>
