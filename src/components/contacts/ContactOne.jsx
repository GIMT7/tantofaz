        ...
        <div className="container">
          <div className="row y-gap-50 justify-between">
            <div className="col-lg-4">
              ...
              <p className="mt-25">
                Estamos aqui para ajudar! Entre em contato com a Nexus Educação
                para qualquer dúvida ou suporte necessário.
              </p>
            ...
            <div className="col-lg-7">
              ...
              <p className="mt-25">
                Preencha o formulário abaixo para entrar em contato com a Nexus
                Educação. Responderemos o mais breve possível.
              </p>
