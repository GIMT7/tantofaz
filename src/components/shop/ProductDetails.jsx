          ...
          <div className="row y-gap-60 justify-between items-center">
            ...
            <div className="col-lg-5">
              <div className="pb-90 md:pb-0">
                ...
                <div className="mt-30">
                  <p>
                    A Nexus Educação é a sua parceira no aprendizado online.
                    Oferecemos cursos de alta qualidade para ajudar você a
                    alcançar seus objetivos profissionais e pessoais. Com
                    instrutores especializados e uma plataforma intuitiva,
                    aprender nunca foi tão acessível e eficiente.
                  </p>
                </div>
                ...
                <div className="pt-30">
                  <p>Categoria: Educação</p>
                  <p>Tags: Cursos, Online, Nexus Educação</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="tabs__content js-tabs-content lg:px-15 md:px-15">
                    ...
                    >
                      <h4 className="text-18 fw-500">
                        O que torna um curso excelente?
                      </h4>
                      <p className="mt-30">
                      ...
                      <div className="respondForm pt-30">
                        ...
                        <div className="mt-30">
                          <h4 className="text-16 fw-500">
                            Qual é a sua opinião sobre este curso?
                          </h4>
