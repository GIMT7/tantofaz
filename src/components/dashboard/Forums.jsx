          ...
          <div className="col-12">
            <div className="rounded-16 bg-white shadow-4 h-100">
              ...
              <div className="py-30 px-30">
                <h4 className="text-24 lh-12 fw-500">Discussão sobre Cursos</h4>
                <div className="mt-15">
                  Neste espaço, discutiremos aspectos dos cursos e temas gerais de educação. Sinta-se à vontade para levantar questões que possam ajudar em suas atividades e projetos em grupo. Este é um espaço colaborativo! Você pode avaliar outros e visualizar avaliações.
                </div>
                ...
                <div className="d-flex justify-between flex-wrap y-gap-20 items-center mt-50">
                  ...
                  <a
                    ...
                    className="button -icon -purple-3 h-50 text-purple-1"
                  >
                    Compartilhar Exemplos de Educação Digital
                    <i className="icon-arrow-top-right text-13 ml-10"></i>
                  </a>
                </div>
              </div>
